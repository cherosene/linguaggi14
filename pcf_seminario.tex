...
\begin{frame}
	...
	\begin{tikzpicture}[out=45,in=135]
	 ...
	 \node (st_1) at (6.5,-5.5) [minimum size=2pt, scale=1.5] {$*_1$};
	 \node (st_2) at (6.5,-0.5) [minimum size=2pt, scale=1.5] {$*_2$};
	 \node (ri_1) at (5.5,-5.5) [minimum size=2pt, scale=1.5] {$n_1$};
	 \node (ri_2) at (5.5,-0.5) [minimum size=2pt, scale=1.5] {$n_2$};
