  ...
  %\node (em) at (0,0) [minimum size=2pt] {$\epsilon$};
   ...
   %\node (adad) at (10,2.5) [minimum size=2pt] {adad};
    \node (bead) at (10,2) [minimum size=2pt] {bead};
     ...
     \draw[->,color=red] (em_u) -- (a_u);
     \draw[->,color=blue] (em_d) -- (a_d);
     \draw[->,color=blue] (em) -- (b);
     \draw[->,color=red] (em_u) -- (c_u);
     \draw[->,color=blue] (em_d) -- (c_d);
     
     \draw[->,color=red] (a_u) -- (ad_u);
     \draw[->,color=blue] (a_d) -- (ad_d);
     \draw[->,color=blue] (b) -- (be);
     \draw[->] (a) -- (ae);
     \draw[->] (b) -- (bf);
     \draw[->] (b) -- (bd);
     \draw[->,color=red] (c_u) -- (ch_u);
     \draw[->,color=blue] (c_d) -- (ch_d);
     \draw[->] (c) -- (ce);
     \draw[->] (c) -- (cf);
     
     \draw[->,color=red] (ad_u) -- (ada_u);
     \draw[->,color=blue] (ad_d) -- (ada_d);
     \draw[->,color=blue] (be) -- (bea);
     \draw[->] (ch) -- (chi);
     \draw[->] (ch) -- (chg);
     
     \draw[->,color=red] (ada_u) -- (adad_u);
     \draw[->,color=blue] (ada_d) -- (adad_d);
     \draw[->,color=blue] (bea) -- (bead);
