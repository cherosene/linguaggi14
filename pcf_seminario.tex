...
\only<6>{
	...
	\includegraphics<1>[width=1.5\textwidth, height=0.7\textheight]{Drawing}
	\includegraphics<2>[width=\textwidth, height=0.7\textheight]{classi}
	%\includegraphics<3>[width=1.3\textwidth, height=0.6\textheight]{sigma}
	\includegraphics<3-6>[width=\textwidth, height=0.65\textheight]{sigmatau}
