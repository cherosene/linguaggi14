...
\begin{frame}
	...
	\only<1->{	 \draw [fill=cyan, opacity=.5] (3.5,-4) rectangle (.5,-1);
...
\begin{frame}
	...
	\only<1->{	 \draw [fill=green, opacity=.5] (3.5,-4) rectangle (.5,-1);
			 ...
			 \only<1-> {\node (num_n) at (2.5,-4.5) [minimum size=2pt, scale=1.5] {$\underline{n}$};}
			  ...
			  \only<1->{\draw[->] [out=280,in=80] (st) to (num_n);}
...
\begin{frame}
	...
	\only<1->{	 \draw [fill=green, opacity=.5] (3.5,-4) rectangle (.5,-1);
			 ...
			 \only<5> {\node (num_2) at (2.5,-4.5) [minimum size=2pt, scale=1.5] {$m_2$};}
			  ...
			  \only<5>{\draw[->] [out=280,in=80] (st_2) to (num_2);}
...
\begin{frame}
	...
	\only<1->{	 \draw [fill=green, opacity=.5] (3,-4) rectangle (0,-1);
			 ...
			 \node (P_1) at (0.5,-3.5) [minimum size=2pt, scale=2.5] {P};
			 \node (O_1) at (0.5,-1.5) [minimum size=2pt, scale=2.5] {O};}
			 
	\only<1->{	 \draw [fill=green, opacity=.5] (6.5,-4) rectangle (3.5,-1);
			 \node (N_2) at (5,-2.5) [minimum size=2pt, scale=4] {$N_2$};
			 \node (P_2) at (4,-3.5) [minimum size=2pt, scale=2.5] {P};
			 \node (O_2) at (4,-1.5) [minimum size=2pt, scale=2.5] {O};}
	...
	\only<1->{	 \draw [fill=green, opacity=.5] (10.5,-4) rectangle (7.5,-1);
			 ...
			 \only<3-> {\node (st_2) at (2.5,-4.5) [minimum size=2pt, scale=1.5] {$*_{1,1}$};}
			 \only<4-> {\node (num_1) at (2.5,-.5) [minimum size=2pt, scale=1.5] {$n_{1,1}$};}
			 \only<5-> {\node (st_3) at (6,-4.5) [minimum size=2pt, scale=1.5] {$*_{2,n}$};}
			 \only<6-> {\node (num_2) at (6,-.5) [minimum size=2pt, scale=1.5] {$m_{2,n}$};}
			 \only<7-> {\node (num_3) at (10,-4.5) [minimum size=2pt, scale=1.5] {$(n+m)_3$};}
			 


\only<3->{\draw[->] (st_1) to (st_2);}
\only<4->{\draw[->] (st_2) to (num_1);}
\only<5->{\draw[->] (num_1) to (st_3);}
...
\begin{frame}
	...
	\only<1->{	 \draw [fill=green, opacity=.5] (10.5,-4) rectangle (7.5,-1);
			...
			% MOSSE
			 ...
			 \only<3-> {\node (mv_2) at (2.5,-4.5) [minimum size=2pt, scale=1.5] {$*_3$};}
			 \only<4-> {\node (mv_3) at (0.5,-.5) [minimum size=2pt, scale=1.5] {$*_{1,1}$};}
			 \only<5-> {\node (mv_4) at (5,-4.5) [minimum size=2pt, scale=1.5] {$*_{4,1}$};}
			 \only<6-> {\node (mv_5) at (5,-.5) [minimum size=2pt, scale=1.5] {$n_{4,1}$};}
			 \only<7-> {\node (mv_6) at (0.5,-4.5) [minimum size=2pt, scale=1.5] {$n_{1,1}$};}
			 \only<8-> {\node (mv_7) at (1.5,-.5) [minimum size=2pt, scale=1.5] {$*_{2,n}$};}
			 \only<9-> {\node (mv_8) at (6,-4.5) [minimum size=2pt, scale=1.5] {$*_{5,n}$};}
			 \only<10-> {\node (mv_9) at (6,-.5) [minimum size=2pt, scale=1.5] {$m_{5,n}$};}
			 \only<11-> {\node (mv_10) at (1.5,-4.5) [minimum size=2pt, scale=1.5] {$m_{2,n}$};}
			 \only<12-> {\node (mv_11) at (2.8,-.5) [minimum size=2pt, scale=1] {$(n+m)_3$};}
...
\begin{frame}
	...
	\only<1->{	 \draw [fill=cyan, opacity=.5] (10.5,-4) rectangle (7.5,-1);
			...
			% MOSSE
			 ...
			 \only<2-> {\node (mv_9) at (6,-.5) [minimum size=2pt, scale=1.5] {$m_{5,n}$};}
			 \only<2-> {\node (mv_10) at (1.5,-4.5) [minimum size=2pt, scale=1.5] {$m_{2,n}$};}
			 \only<2-> {\node (mv_11) at (2.8,-.5) [minimum size=2pt, scale=1] {$f_3$};}
...
\begin{frame}
	...
	\only<1->{	 \draw [fill=green, opacity=.5] (4,-4) rectangle (1,-1);
			 \node (N_1) at (2.5,-2.5) [minimum size=2pt, scale=4] {$N_1$};
			 \node (P_1) at (1.5,-3.5) [minimum size=2pt, scale=2.5] {P};
			 \node (O_1) at (1.5,-1.5) [minimum size=2pt, scale=2.5] {O};}
			 
	\only<1->{	 \draw [fill=green, opacity=.5] (9.5,-4) rectangle (6.5,-1);
			 \node (N_2) at (8,-2.5) [minimum size=2pt, scale=4] {$N_2$};
			 \node (P_2) at (7,-3.5) [minimum size=2pt, scale=2.5] {P};
			 \node (O_2) at (7,-1.5) [minimum size=2pt, scale=2.5] {O};}
			 
			
			 
			 \only<2-> {\node (mv_1) at (9,-.5) [minimum size=2pt, scale=1.5] {$*_2$};}
			 \only<3-> {\node (mv_2) at (3.5,-4.5) [minimum size=2pt, scale=1.5] {$*_1$};}
			 \only<4-> {\node (mv_3) at (3.5,-.5) [minimum size=2pt, scale=1.5] {$n_1$};}
			 \only<5-> {\node (mv_4) at (9,-4.5) [minimum size=2pt, scale=1.5] {$n_2$};}
...
\begin{frame}
	...
	\only<1->{	 \draw [fill=orange, opacity=.5] (4.5,-4) rectangle (0.5,-1);
			 ...
			 \node (P_1) at (1,-3.5) [minimum size=2pt, scale=2.5] {P};
			 \node (O_1) at (1,-1.5) [minimum size=2pt, scale=2.5] {O};}
	...
	\only<1->{	 \draw [fill=green, opacity=.5] (9.5,-4) rectangle (6.5,-1);
			 ...
			 \only<3-> {\node (mv_2) at (2,-4.5) [minimum size=2pt, scale=1.5] {$*_1$};}
			 \only<4-> {\node (mv_3) at (2,-.5) [minimum size=2pt, scale=1.5] {$f_1$};}
			 \only<5-> {\node (mv_4) at (4,-4.5) [minimum size=2pt, scale=1.5] {$*_3$};}
			 \only<6-> {\node (mv_5) at (4,-.5) [minimum size=2pt, scale=1.5] {$n_3$};}
