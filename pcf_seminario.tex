...
\begin{frame}
	...
	\only<1->{	 \draw [fill=green, opacity=.5] (4,-3) rectangle (2,-1);
			 \node (N_1) at (3,-2) [minimum size=2pt, scale=2] {$N_1$};
			 \node (P_1) at (2.25,-1.25) [minimum size=2pt, scale=1.5] {P};
			 \node (O_1) at (2.25,-2.75) [minimum size=2pt, scale=1.5] {O};}
	...
	\only<1->{	 \draw [fill=green, opacity=.5] (8.5,-3) rectangle (6.5,-1);
			 ...
			 \only<3-> {\node (mv_2) at (3.5,-3.5) [minimum size=2pt, scale=1.5] {$*_1$};}
