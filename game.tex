...
% strategia composizione
\begin{frame}

	\frametitle{La strategia $\sigma ; \tau$}
Date due strategie $\sigma$ del gioco $A\limp B$ e $\tau$ del gioco $B\limp C$, possiamo definire la strategia \emph{composizione} $\sigma ; \tau$ del gioco $A\limp C$:
