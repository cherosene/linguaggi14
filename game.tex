...
\begin{frame}
 ...
 Estendiamo la relazione $\approx$ alle strategie, ponendo:
	\begin{itemize}
	\item $\underline{ \sigma \preccurlyeq \tau }$ se per ogni $sab \in \sigma$ e $s' \in \tau$ t.c. $sa\approx s'a'$, esiste $b'$ tale che $s'a'b' \in \tau$ e $sab\approx s'a'b'$
	\item $\underline{ \sigma \approx \tau \ } \; \text{sse} \; \sigma \preccurlyeq \tau \wedge \tau \preccurlyeq \sigma$
	\end{itemize}  
	...
	\begin{itemize}
		...
		\item Nel caso l'equivalenza $\approx$ del gioco sia l'identità, l'ordine tra strategie si può vedere come inclusione di insiemi o tra le funzioni parziali. Intuitivamente, $\sigma \preccurlyeq \tau$ se $\tau$ può fare più mosse di $\sigma$
	\end{itemize}
