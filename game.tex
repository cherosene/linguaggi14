...
\frametitle{Tavolo di Gioco}
	...
	\begin{tikzpicture}
			 \node (inv) at (4,0) [minimum size=2pt] {};
			 \node (inv2) at (7,-1) [minimum size=2pt, scale=1] {};
			\node (text) at (0,-.5) [minimum size=2pt] {Bracketing condition:};
			
			 \node (A) at (5,0) [minimum size=2pt, scale=1] {A};
			 \node (P) at (5.5,-.5) [minimum size=2pt, scale=1] {P};
			 \node (O) at (6,-1) [minimum size=2pt, scale=1] {O};
